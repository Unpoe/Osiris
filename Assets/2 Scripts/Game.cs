...
namespace Osiris
{
    public class Game : MonoBehaviour, IPersistableObject
    {
        ...
        [SerializeField] private FloatingNumbersGroup floatingNumbersGroup = default;
        ...
        private void Awake() {
            ...
            floatingNumbersGroup.Initialize(mainCamera);

            // Initialize battle
            battle = new Battle(actorFactory, projectileFactory, grid, lifebarGroup, floatingNumbersGroup, catalog, initialGold);
